    ...
    <div className="navbar bg-gray-100 shadow-lg">
      <div className="flex-none">
        <div className="dropdown">
          ...
          >
            <div className="space-y-4 bg-gray-100 shadow-lg rounded-box mt-4">
              <div className="flex items-center justify-between">
                <h2 className="text-center w-full">Menu</h2>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  name="Search"
                  placeholder="Search..."
                  className="w-full py-2 pl-10 text-sm dark:border-transparent rounded-md focus:outline-none"
                />
              </div>
              <div className="flex-1">
                <ul className="pt-2 pb-4 space-y-1 text-sm">
                  <li className="rounded-2xl hover:rounded-2xl hover:bg-gray-300 transition duration-300 ease-in-out">
                    <a
            ...
            <div className="flex items-center p-2 mt-5 space-x-4 justify-self-end bg-gray-100 shadow-lg rounded-box">
              <img
